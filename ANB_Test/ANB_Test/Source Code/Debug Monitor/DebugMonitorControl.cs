...
namespace ANB_Test.Debug_Monitor
{
    ...
    class DebugMonitorControl : GraphicsDeviceControl
    {
        ...
        protected override void Draw()
        {
            ...
            Tactile.Global.debug_monitor.draw(spriteBatch, content);
        }
        ...
        {
            Tactile.Global.debug_monitor.change_variable_group(group);
        }

        internal void reseed_rng()
        {
            Tactile.Global.reseed_rng();
        }

        internal void open_debug_menu()
        {
            Tactile.Global.open_debug_menu();
        }
    }
}
#endif
