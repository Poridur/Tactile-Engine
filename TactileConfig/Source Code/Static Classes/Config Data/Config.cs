...
namespace Tactile
{
    ...
    public class Config
    {
        ...
        #region Text
        public const string CHAPTER_FONT = "ChapterFont"; // Used by chapter titles
        public const string CONVO_FONT = "ConvoFont"; // Used in conversation bubbles and help text
        public const string REEL_SPLASH_FONT = "ReelFont"; // Used in the splash screen before class reel data screens
        public const string REEL_FONT = "ReelFont2"; // Used in class reel data screens
        public const string UI_FONT = "UiFont"; // Generic font used in the user interface

        public const string COMBAT_DIGITS_FONT = "CombatFont"; // Used by stats in action scenes
        public const string INFO_FONT = "InfoFont"; // Used for map info windows
        public const string LEVEL_STAT_FONT = "LevelStatFont"; // Used for level up stat changes
        public const string PROMOTION_STAT_FONT = "PromotionStatFont"; // Used for promotion stat changes
        #endregion
